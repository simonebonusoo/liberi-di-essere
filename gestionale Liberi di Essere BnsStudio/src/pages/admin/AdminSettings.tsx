...
export function AdminSettings() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="heading-serif text-3xl text-brand-900">Disponibilità & Chiusure</h1>
        <p className="mt-1 text-brand-500">Gestisci gli orari di lavoro e i giorni di chiusura.</p>
      </div>
