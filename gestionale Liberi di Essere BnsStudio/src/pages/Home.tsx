...
export function Home() {
  ...
  return (
    <div>
      ...
      {/* RECENSIONI */}
      <section className="section container-page">
        <SectionHeading eyebrow="Dicono di noi" title="Recensioni dei clienti" />
        <div className="mt-10 grid gap-6 md:grid-cols-3">
          {c.reviews.map((r) => (
            <Card key={r.name}>
              ...
              <p className="mt-3 text-brand-700">“{r.text}”</p>
              <p className="mt-4 text-sm font-semibold text-brand-900">{r.name}</p>
            </Card>
          ))}
        </div>
      </section>
